<x-layout :title="$title">
    <main>
        @section('content')
            <div class="mx-auto max-w-7xl px-3 py-6 sm:px-4 lg:px-3">
                            ...
                            @foreach ($Gudang as $tempat)
                                <tr class="even:bg-blue-50">
                                    ...
                                    <td class="">
                                        ...
                                        <form class="inline-block" method="POST" action="/delete/gudang/{{ $tempat['id_gudang'] }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('Apakah anda yakin ingin menghapus {{ $tempat['nm_tempat'] }}')" class="m-2" title="Hapus">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-yellow-500 hover:fill-red-700" viewBox="0 0 24 24">
                                                <path
                ...
                <div class="font-[sans-serif] overflow-x-auto flex flex-row">
                    <div class="font-[sans-serif] overflow-x-auto flex flex-row">
                        <a href="/save/gudang" type="button"
                        ...
                        <a href="/softDelInfo/gudang" type="button"
